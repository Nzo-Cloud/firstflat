...
function DashboardContent() {
  ...
  if (loading) return <div className="p-6"><LoadingSpinner text="Loading your dashboard..." /></div>
...
export default function DashboardPage() {
  return (
    <AppLayout>
      <Suspense fallback={<div className="p-6"><LoadingSpinner text="Loading your dashboard..." /></div>}>
        <DashboardContent />
      </Suspense>
    </AppLayout>
  )
